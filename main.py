...
from internal.api.admin import admin_auth, admin_user_operations, admin_requests
...
app.include_router(admin_requests.router, prefix=get_config("api_prefix"), tags=["Admin Request Management"])
